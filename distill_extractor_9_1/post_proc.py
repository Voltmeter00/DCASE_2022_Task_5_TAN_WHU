...
if __name__ == "__main__":
    ...
    experiment_result_path = "/home/tyz/data/data_experiment/DCASE_2022_few_shot/2021_rank_3"
    ...
    parser.add_argument('-new_evaluation_file', type=str, help="name of prost processed prediction file to be saved",default=os.path.join(experiment_result_path,"adaptive_eval_out.csv"))
